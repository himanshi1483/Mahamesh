namespace Mahamesh.Migrations
{
    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.PressInformationModels",
                c => new
                    {
                        InformationId = c.Int(nullable: false, identity: true),
                        InformationTitle = c.String(),
                        InformationDescription = c.String(),
                        InformationDate = c.DateTime(),
                        InformationDocument = c.String(),
                        CreatedBy = c.String(),
                        CreatedDate = c.DateTime(nullable: false),
                        UpdatedBy = c.String(),
                        UpdatedDate = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.TenderModels");
            DropTable("dbo.AspNetUserRoles");
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.PressInformationModels");
